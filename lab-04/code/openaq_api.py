        ...
        for loc in results:
            ...
            for sensor in sensors:
                ...
                records.append({
                    ...
                    "pollutant_id": param.get("id"),
                    "pollutant": param.get("name"),
                    "pollutant_displayName": param.get("displayName"),
                    "pollutant_units": param.get("units"),
    ...
    for _, row in df_sensors.iterrows():
        ...
        for year in sensors_data:
            ...
            records.append({
                "city": city,
                "sensor_id": sid,
                "pollutant_name": param_data.get("name"),
                "pollutant_units": param_data.get("units"),
